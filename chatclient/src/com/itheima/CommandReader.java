...
public class CommandReader extends Thread {
    ...
    public void run() {
        try {
            ...
            System.out.println("发生未知错误，连接异常");
            e.printStackTrace();
        }
    }
    ...
    // 3.表示单聊
    private void sendOne(PrintStream ps) {
    ...
    // 4.表示群聊
    private void sendAll(PrintStream ps) {
    ...
    // 6.获取上线用户根据用户名升序排序
    private void getAllOnlineUserOrderByName(PrintStream ps) {
    ...
    // 7.获取指定性别的上线用户
    private void getAllOnlineUserFilterBySex(PrintStream ps) {
    ...
    // 8.获取已上线的所有用户
    private void getAllOnlineUser(PrintStream ps) {
